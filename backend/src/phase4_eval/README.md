...
### 4.2 Tầng 1 — Fast Pre-Filter (chạy trên CPU, không tốn VRAM)
...
### 4.3 Tầng 2 — Deep Judge bằng Prometheus-2 (chỉ chấm case biên)
...
### 4.4 Đối chiếu Ground Truth (tuỳ chọn)
...
### 4.6 Tính năng liên quan: Tự động tối ưu trọng số (`--tune_weights`)
